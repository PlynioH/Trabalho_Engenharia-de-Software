...
CREATE TABLE HO_PACIENTE(
    ...
    PACIENTE_ST_TELEFONE VARCHAR(14) NOT NULL CHECK(PACIENTE_ST_TELEFONE LIKE 
	'[(][0-9][0-9][)][0-9][0-9][0-9][0-9][0-9][-][0-9][0-9][0-9][0-9]'),
    PACIENTE_ST_CPF VARCHAR(14) NOT NULL UNIQUE CHECK(PACIENTE_ST_CPF LIKE 
	'[0-9][0-9][0-9][.][0-9][0-9][0-9][.][0-9][0-9][0-9][-][0-9][0-9]'),
...
CREATE TABLE HO_USUARIO(
    ...
    USUARIO_ST_CPF VARCHAR(14) NOT NULL UNIQUE CHECK(USUARIO_ST_CPF LIKE 
	'[0-9][0-9][0-9][.][0-9][0-9][0-9][.][0-9][0-9][0-9][-][0-9][0-9]'),
    USUARIO_ST_EMAIL VARCHAR(30) NOT NULL,
    USUARIO_IN_NUMREGISTO INT NOT NULL UNIQUE,
